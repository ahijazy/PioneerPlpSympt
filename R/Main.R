...
#
# This file is part of PioneerPlpSympt
#
...
#'
#' @details
#' This function executes the PioneerPlpSympt Study.
#' 
  ...
  if(createValidationPackage){
      ...
      tryCatch({
        ...
        createValidationPackage(
          devPackageName = 'PioneerPlpSympt',
          devDatabaseName = databaseDetails$cdmDatabaseName,
          analysisLocation = outputFolder,
          analysisIds = analysesToValidate,
          outputFolder = outputFolder,
          validationPackageName = 'PioneerPlpSymptValidation',
          description = 'validating models in PioneerPlpSympt',
          createdBy = 'anonymous',
